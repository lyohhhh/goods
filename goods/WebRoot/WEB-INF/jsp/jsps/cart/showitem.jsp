...
<script type="text/javascript">
  ...
  <body>
  <c:choose>
  	<c:when test="${empty cartItemList }">无订单项</c:when>
  	<c:otherwise>
  		<form id="form1" action="<c:url value='/order/createOrder'/>" method="post">
			...
			<table width="95%" align="center" cellpadding="0" cellspacing="0">
				...
				<c:forEach items="${cartItemList }" var="cartItem">
					<tr align="center">
						<td align="right">
							<a class="linkImage" href="<c:url value='/book/load?bid=${cartItem.book.bid }'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.book.image_b }'/>"/></a>
						</td>
						<td align="left">
							<a href="<c:url value='/book/load?bid=${cartItem.book.bid }'/>"><span>${cartItem.book.bname }</span></a>
						</td>
